...
public class Advancedmedia extends Application {
	...
	public class MediaControl extends BorderPane {
		...
		public MediaControl(final MediaPlayer mp) {
			...
			mvPane.setStyle("-fx-background-color: black;"); // TODO: Use css
																// file
			setCenter(mvPane);
			...
			Button buttonFullScreen = ButtonBuilder.create()
					.text("Full Screen").minWidth(Control.USE_PREF_SIZE)
					.build();
			...
			buttonFullScreen.setOnAction(new EventHandler<ActionEvent>() {
				...
				public void handle(ActionEvent event) {
					if (!fullScreen) {
						newStage = new Stage();
						newStage.fullScreenProperty().addListener(
						...
						final BorderPane borderPane = new BorderPane() {
							...
							protected void layoutChildren() {
								...
								if (mediaView != null) {
									mediaView
											.setTranslateX((((Pane) getCenter())
													.getWidth() - mediaView
													.prefWidth(-1)) / 2);
									mediaView
											.setTranslateY((((Pane) getCenter())
													.getHeight() - mediaView
													.prefHeight(-1)) / 2);
								}
							};
